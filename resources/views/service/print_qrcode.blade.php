...
<section class="forms">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="search-box input-group">
                                            ...
                                            <input type="text" name="service_code_name" id="servicecodeSearch" placeholder="Please type service code and select..." class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <strong><input type="checkbox" name="name" checked /> Service Name </strong>&nbsp;
    ...
    <div id="print-qrcode" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                  <h5 id="modal_header" class="modal-title">QRcode</h5>&nbsp;&nbsp;
...
<script type="text/javascript">
    ...
    $("ul#service #printQrcode-menu").addClass("active");
    ...
    var servicecodeSearch = $('#servicecodeSearch');

    servicecodeSearch.autocomplete({
...
$("#submit-button").on("click", function(event) {
        ...
        if(paper_size != "0") {
            ...
            for(i = 0; i <= rownumber; i++){
                service_name.push($('table.order-list tbody tr:nth-child(' + (i + 1) + ')').find('td:nth-child(1)').text());
            ...
            $.each(qty, function(index){
                ...
                while(i < qty[index]) {
                    ...
                    if($('input[name="name"]').is(":checked"))
                        htmltext += service_name[index] + '<br>';

                    if(paper_size == 18)
                        htmltext += '<img style="max-width:350px;height:100%;max-height:70px" src="data:image/png;base64,'+barcode_image[index]+'" alt="barcode" /><br>';
                    else
                        htmltext += '<img style="max-width:350px;height:100%;max-height:70px" src="data:image/png;base64,'+barcode_image[index]+'" alt="barcode" /><br>';
