...
<section>
    ...
    <div class="table-responsive">
        <table id="expense_category-table" class="table">
            ...
            <tbody>
                @foreach($lims_income_source_all as $key=>$income_source)
                <tr data-id="{{$income_source->id}}">
                    <td>{{$key}}</td>
                    <td>{{ $income_source->code }}</td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li><button type="button" data-id="{{$income_source->id}}" class="open-Editincome_sourceDialog btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</button></li>
                                <li class="divider"></li>
                                {{ Form::open(['route' => ['income_source.destroy', $income_source->id], 'method' => 'DELETE'] ) }}
                                <li>
...
<div id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        {!! Form::open(['route' => 'income_source.store', 'method' => 'post', 'files' => true]) !!}
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div class="modal-content">
        {{ Form::open(['route' => ['income_source.update', 1], 'method' => 'PUT', 'files' => true] ) }}
      <div class="modal-header">
