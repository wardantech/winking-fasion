...
<table style="border-collapse: collapse; width: 100%;">
	...
	<tbody>
		...
		<tr>
			...
			<td style="border: 1px solid #000; padding: 5px">{{$unit_price[$key]}}</td>
            <td style="border: 1px solid #000; padding: 5px">{{$discount[$key]}}</td>
            <td style="border: 1px solid #000; padding: 5px">{{$tax[$key]}}</td>
