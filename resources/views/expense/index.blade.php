        ...
        <table id="expense-table" class="table">
            <thead>
                <tr>
                    ...
                    <th style="min-width: 65px !important;">{{trans('file.Date')}}</th>
                    <th style="min-width: 65px !important;">{{trans('Billing Date')}}</th>
                    <th style="min-width: 65px !important;">{{trans('Payment Date')}}</th>
            ...
            <tbody>
                ...
                <tr data-id="{{$expense->id}}">
                    <td>{{$key}}</td>
                    <td>{{date('d-M-Y', strtotime($expense->created_at->toDateString())) }}</td>
                    <td>{{ date('d-M-Y',strtotime($expense->billing_date)) }}</td>
                    <td>
