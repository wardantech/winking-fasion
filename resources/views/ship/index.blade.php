...
<section>
    ...
    <div class="container-fluid">
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> {{trans("Add Ship To")}}</button>&nbsp;
    </div>
    ...
    <div class="table-responsive">
        <table id="user-table" class="table">
            ...
            <tbody>
                @foreach($lims_ship_to as $key => $ship)
                    <tr data-id="{{ $ship->id }}">
                        <td>{{$key}}</td>
                        <td>{{ $ship->name }}</td>
                        <td>{{ $ship->email }}</td>
                        <td>{{ $ship->phone }}</td>
                        <td>{{ $ship->address }}, {{ $ship->city }}, {{$ship->state}}, {{$ship->zip}}, {{ $ship->country }}</td>
                        @if ($ship->is_active == 1)
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    ...
                                    <li><button type="button" data-id="{{ $ship->id }}" class="open-EditCategoryDialog btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</button></li>

                                    <li class="divider"></li>
                                    {{ Form::open(['route' => ['shipTo.delete', $ship->id], 'method' => 'GET'] ) }}
                                    <li>
...
<div id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        {!! Form::open(['route' => 'ship_to.store', 'method' => 'post', 'files' => true]) !!}
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title">{{trans('Add Ship To')}}</h5>
          ...
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    ...
                    {{Form::text('zip',null,array('required' => 'required','class' => 'form-control', 'placeholder' => 'Type zip code...'))}}
                </div>
                <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group">
                    ...
                    {{Form::email('email',null,array('class' => 'form-control', 'placeholder' => 'Type email address...'))}}
                </div>
                <div class="col-md-6 form-group">
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        {{ Form::open(['route' => ['ship.update', 1], 'method' => 'PUT', 'files' => true] ) }}
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title">{{trans('Add Ship To')}}</h5>
          <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
        </div>
