...
<section>
    <div class="container-fluid">
        <button class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> Add Bank</button>&nbsp;
    ...
    <div class="table-responsive">
        <table id="biller-table" class="table">
            ...
            <tbody>
                @foreach($lims_all_bank as $key=>$bank)
                <tr data-id="{{$bank->id}}">
                    <td>{{$key}}</td>
                    <td>{{ $bank->name }}</td>
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li><button type="button" data-id="{{$bank->id}}" class="open-EditbankDialog btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</button></li>
                                <li class="divider"></li>
        ...
        <div class="modal-body">
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            <div class="form-group">
                ...
                {{Form::text('name',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'Type bank name...'))}}
            </div>
            <div class="form-group">
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div class="modal-content">
        {{ Form::open(['route' => ['banks.update', 1], 'method' => 'PUT', 'files' => true] ) }}
      <div class="modal-header">
    ...
    $(document).ready(function() {
        $('.open-EditbankDialog').on('click', function() {
            ...
            $.get(url, function(data) {
                ...
                $("#editModal input[name='bank_id']").val(data['id']);
