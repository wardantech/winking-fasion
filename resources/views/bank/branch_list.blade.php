...
<section>
    <div class="container-fluid">
        <button class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> Add Bank Branch</button>&nbsp;
    ...
    <div class="table-responsive">
        <table id="biller-table" class="table">
            ...
            <tbody>
                @foreach($lims_bank_branch_data as $key=>$bank_branch)
                <tr data-id="{{$bank_branch->id}}">
                    <td>{{$key}}</td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li><button type="button" data-id="{{$bank_branch->id}}" class="open-EditbankDialog btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</button></li>
                                <li class="divider"></li>
                                {{ Form::open(['route' => ['bank_branches.destroy', $bank_branch->id], 'method' => 'DELETE'] ) }}
                                <li>
        ...
        <div class="modal-body">
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" required class="form-control" placeholder = "Type bank branch name...">
            </div>
            <div class="form-group">
                <label>address *</label>
...
<script type="text/javascript">
    ...
    $("ul#bank #bank-menu").addClass("active");
