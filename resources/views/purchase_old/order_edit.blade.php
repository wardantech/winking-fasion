                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="rivision_no" class="form-control" value={{$lim_order_data->rivision_no}}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="order_date" class="form-control" value={{$lim_order_data->order_date}} required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="ship_exp_date" class="form-control" value={{$lim_order_data->ship_exp_date}} required>
                                        ...
                                        <table id="colorSection" width="100%">
                                             ...
                                             <tbody>
                                                 <tr>
                                                     ...
                                                     <td><input type="number" min="0" step="any" name="color_wise_quantity[]" value={{$value->color_wise_quantity}} id="color_wise_quantity1" class="form-control color_wise_quantity1" readonly></td>
                                                     <td><input type="number" min="0" step="any" name="color_unit_price[]" id="color_unit_price1" value={{$value->color_unit_price}} class="form-control color_unit_price1"></td>
                                                     <td><input type="number" min="0" step="any" name="sub_total[]" id="sub_total1" value={{$value->sub_total}} class="form-control sub_total1" readonly></td>
                                                 </tr>
                                             </tbody>
                                        </table>
                                        ...
                                        <table id="sizeSection" width="100%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><input type="number" min="0" step="any" name="quantity1[]" value={{$value->quantity1}} id="quantity1" class="form-control quantity1"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" min="0" step="any" name="quantity2[]" value={{$value->quantity2}} id="quantity1" class="form-control quantity1"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" min="0" step="any" name="quantity3[]" value={{$value->quantity3}} id="quantity1" class="form-control quantity1"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" min="0" step="any" name="quantity4[]" value={{$value->quantity4}} id="quantity1" class="form-control quantity1"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" min="0" step="any" name="quantity5[]" value={{$value->quantity5}} id="quantity1" class="form-control quantity1"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" min="0" step="any" name="quantity6[]" value={{$value->quantity6}} id="quantity1" class="form-control quantity1"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" min="0" step="any" name="quantity7[]" value={{$value->quantity7}} id="quantity1" class="form-control quantity1"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" min="0" step="any" name="quantity8[]" value={{$value->quantity8}} id="quantity1" class="form-control quantity1"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="number" min="0" step="any" name="quantity9[]" value={{$value->quantity9}} id="quantity1" class="form-control quantity1"></td>
                                                </tr>
                                            </tbody>
                                       </table>
                                    </div>
