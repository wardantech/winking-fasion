                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <a href="{{route('employees.show',$employee->id)}}" class="btn btn-link"><i class="fa fa-eye"></i> {{trans('Profile')}}</a>
                                </li>
                                @if(in_array("employees-edit", $all_permission))
                                <li>
                                    <button type="button" data-id="{{$employee->id}}" data-joining_date="{{$employee->joining_date}}" data-joining_salary="{{$employee->joining_salary}}" data-designation="{{$employee->designation}}" data-present_salary="{{$employee->present_salary}}" data-name="{{$employee->name}}" data-email="{{$employee->email}}" data-phone_number="{{$employee->phone_number}}" data-nid_number="{{$employee->nid_number}}" data-address2="{{$employee->address2}}" data-department_id="{{$employee->department_id}}" data-address="{{$employee->address}}" data-city="{{$employee->city}}" data-country="{{$employee->country}}" class="edit-btn btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</button>
                                </li>
                                @endif
                                <li class="divider"></li>
