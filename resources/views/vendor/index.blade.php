...
<section>
    ...
    <div class="container-fluid">
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> {{trans("Add Vendor / Shipper")}}</button>&nbsp;
    </div>
    ...
    <div class="table-responsive">
        <table id="user-table" class="table">
            ...
            <tbody>
                @foreach($lims_vendor as $key => $vendor)
                    <tr data-id="{{ $vendor->id }}">
                        <td>{{$key}}</td>
                        <td>{{ $vendor->name }}</td>
                        <td>{{ $vendor->email }}</td>
                        <td>{{ $vendor->phone }}</td>
                        <td>{{ $vendor->address }}, {{ $vendor->city }}-{{$vendor->state}}. {{ $vendor->country }}</td>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    ...
                                    <li><button type="button" data-id="{{ $vendor->id }}" class="open-EditCategoryDialog btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</button></li>
    ...
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title">{{trans('Add Vendor / Shipper')}}</h5>
          ...
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    ...
                    {{Form::text('state',null,array('required' => 'required','class' => 'form-control', 'placeholder' => 'Type zip code...'))}}
                </div>
                <div class="col-md-6 form-group">
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        {{ Form::open(['route' => ['vendors.update', 1], 'method' => 'PUT', 'files' => true] ) }}
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title">{{trans('Edit Vendor / Shipper')}}</h5>
          <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
        </div>
        <div class="modal-body">
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    <label>{{trans('ZIP Code')}}</label>
                    {{Form::text('state',null,array('class' => 'form-control', 'placeholder' => 'Type zip code...'))}}
                </div>
                <div class="col-md-6 form-group">
                    <label>{{trans('file.Country')}} *</label>
                    {{Form::text('country',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'Type country name...'))}}
