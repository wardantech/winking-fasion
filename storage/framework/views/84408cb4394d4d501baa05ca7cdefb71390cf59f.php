                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <a href="<?php echo e(route('employees.show',$employee->id)); ?>" class="btn btn-link"><i class="fa fa-eye"></i> <?php echo e(trans('Profile')); ?></a>
                                </li>
                                <?php if(in_array("employees-edit", $all_permission)): ?>
                                <li>
                                    <button type="button" data-id="<?php echo e($employee->id); ?>" data-joining_date="<?php echo e($employee->joining_date); ?>" data-joining_salary="<?php echo e($employee->joining_salary); ?>" data-designation="<?php echo e($employee->designation); ?>" data-present_salary="<?php echo e($employee->present_salary); ?>" data-name="<?php echo e($employee->name); ?>" data-email="<?php echo e($employee->email); ?>" data-phone_number="<?php echo e($employee->phone_number); ?>" data-nid_number="<?php echo e($employee->nid_number); ?>" data-address2="<?php echo e($employee->address2); ?>" data-department_id="<?php echo e($employee->department_id); ?>" data-address="<?php echo e($employee->address); ?>" data-city="<?php echo e($employee->city); ?>" data-country="<?php echo e($employee->country); ?>" class="edit-btn btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></button>
                                </li>
                                <?php endif; ?>
                                <li class="divider"></li>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\salepro\winking-fasion\resources\views/employee/index.blade.php ENDPATH**/ ?>