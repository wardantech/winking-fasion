 <?php $__env->startSection('content'); ?>
    <?php if($errors->has('name')): ?>
        <div class="alert alert-danger alert-dismissible text-center">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                    aria-hidden="true">&times;</span></button><?php echo e($errors->first('name')); ?>
    ...
    <?php if($errors->has('image')): ?>
        <div class="alert alert-danger alert-dismissible text-center">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                    aria-hidden="true">&times;</span></button><?php echo e($errors->first('image')); ?>
    ...
    <?php if($errors->has('email')): ?>
        <div class="alert alert-danger alert-dismissible text-center">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                    aria-hidden="true">&times;</span></button><?php echo e($errors->first('email')); ?>
                    ...
                    <?php $__currentLoopData = $lims_employee_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr data-id="<?php echo e($employee->id); ?>">
                            ...
                            <?php if($employee->image): ?>
                                <td> <img src="<?php echo e(url('public/images/employee', $employee->image)); ?>" height="80"
                                        width="80">
                                </td>
                            <?php else: ?>
                                <td>No Image</td>
                            ...
                            <td><?php echo e($employee->address); ?>
                                ...
                                <?php if($employee->state): ?>
                                    <?php echo e(', ' . $employee->state); ?>

                                <?php endif; ?>
                                <?php if($employee->postal_code): ?>
                                    <?php echo e(', ' . $employee->postal_code); ?>

                                <?php endif; ?>
                                <?php if($employee->country): ?>
                                    <?php echo e(', ' . $employee->country); ?>
                            ...
                            <td>
                                <?php if(isset($employee->image_cv)): ?>
                                    <a href="public/images/employee/cv/<?php echo e($employee->image_cv); ?>" class="btn btn-link"
                                        style="font-size:12px;"> <i class="dripicons-download"></i>
                                        <?php echo e(trans('Download CV')); ?></a>
                                <?php endif; ?>
                            </td>
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                        user="menu">
                                        <li>
                                            <a href="<?php echo e(route('employees.show', $employee->id)); ?>" class="btn btn-link"><i
                                                    class="fa fa-eye"></i> <?php echo e(trans('Profile')); ?></a>
                                        </li>
                                        <?php if(in_array('employees-edit', $all_permission)): ?>
                                            <li>
                                                <button type="button" data-id="<?php echo e($employee->id); ?>"
                                                    data-joining_date="<?php echo e($employee->joining_date); ?>"
                                                    data-joining_salary="<?php echo e($employee->joining_salary); ?>"
                                                    data-designation="<?php echo e($employee->designation); ?>"
                                                    data-present_salary="<?php echo e($employee->present_salary); ?>"
                                                    data-name="<?php echo e($employee->name); ?>" data-email="<?php echo e($employee->email); ?>"
                                                    data-phone_number="<?php echo e($employee->phone_number); ?>"
                                                    data-nid_number="<?php echo e($employee->nid_number); ?>"
                                                    data-address2="<?php echo e($employee->address2); ?>"
                                                    ...
                                                    data-country="<?php echo e($employee->country); ?>"
                                                    data-status="<?php echo e($employee->status); ?>" class="edit-btn btn btn-link"
                                                    data-toggle="modal" data-target="#editModal"><i
                                                        class="dripicons-document-edit"></i>
                                                    <?php echo e(trans('file.edit')); ?></button>
                                            </li>
                                        <?php endif; ?>
                                        <li class="divider"></li>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select class="form-control selectpicker " name="status" id="employe-status"
                                placeholder="Update Employee Status">
                        ...
                        <div class="col-md-6 form-group left-job-date" style="display: none">
                            <label><?php echo e(trans('Left-Job-Date')); ?></label>
                            <input type="date" name="left-job-date" class="form-control"
                                placeholder=" Enter Left-Job-Date">
                        </div>
                        <!--<div class="col-md-6 form-group">-->
    ...
    <script type="text/javascript">
        ...
        $('#employe-status').on('change', function() {
            var status = $("#employe-status").val();
          if(status=="in-active"){
            $(".left-job-date").show();
            }
            else{
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\wingking-fasion\resources\views/employee/index.blade.php ENDPATH**/ ?>