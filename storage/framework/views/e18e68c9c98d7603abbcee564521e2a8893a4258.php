...
<section>
    <div class="container-fluid">
        <button class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> Add Income Source</button>&nbsp;
    ...
    <div class="table-responsive">
        <table id="expense_category-table" class="table">
            ...
            <tbody>
                <?php $__currentLoopData = $lims_income_source_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$income_source): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr data-id="<?php echo e($income_source->id); ?>">
                    <td><?php echo e($key); ?></td>
                    <td><?php echo e($income_source->code); ?></td>
                    <td><?php echo e($income_source->name); ?></td>
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li><button type="button" data-id="<?php echo e($income_source->id); ?>" class="open-Editincome_sourceDialog btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></button></li>
                                <li class="divider"></li>
                                <?php echo e(Form::open(['route' => ['income_source.destroy', $income_source->id], 'method' => 'DELETE'] )); ?>
...
<div id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        <?php echo Form::open(['route' => 'income_source.store', 'method' => 'post', 'files' => true]); ?>

        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title">Add Income Source</h5>
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div class="modal-content">
        <?php echo e(Form::open(['route' => ['income_source.update', 1], 'method' => 'PUT', 'files' => true] )); ?>
      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="income_source_id">
        <div class="form-group">
            <input type="submit" value="<?php echo e(trans('file.submit')); ?>" class="btn btn-primary">
          </div>
        </div>
...
<script type="text/javascript">
    ...
    $("ul#income #income-source-menu").addClass("active");
    ...
    $(document).ready(function() {
        $('.open-Editincome_sourceDialog').on('click', function() {
            var url = "income_source/"
            var id = $(this).data('id').toString();
            url = url.concat(id).concat("/edit");
            $.get(url, function(data) {
                $("input[name='code']").val(data['code']);
                $("input[name='name']").val(data['name']);
                $("input[name='income_source_id']").val(data['id']);
            });
        });
    })
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\salepro\winking-fasion\resources\views/income_source/index.blade.php ENDPATH**/ ?>