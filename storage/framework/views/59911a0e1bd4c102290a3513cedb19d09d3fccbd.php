...
<section>
    ...
    <div class="container-fluid">
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> <?php echo e(trans("Add Notify Party")); ?></button>&nbsp;
    </div>
    ...
    <div class="table-responsive">
        <table id="user-table" class="table">
            ...
            <tbody>
                <?php $__currentLoopData = $notify_parties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $notify): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-id="<?php echo e($notify->id); ?>">
                            <td><?php echo e($key); ?></td>
                            <td><?php echo e($notify->name); ?></td>
                            <td><?php echo e($notify->email); ?></td>
                            <td><?php echo e($notify->phone); ?></td>
                            <td><?php echo e($notify->address); ?>, <?php echo e($notify->state); ?>,<?php echo e($notify->city); ?>, <?php echo e($notify->zip_code); ?>, <?php echo e($notify->country); ?></td>
                            <?php if($notify->is_active == 1): ?>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                        ...
                                        <li><button type="button" data-id="<?php echo e($notify->id); ?>" class="open-EditCategoryDialog btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></button></li>

                                        <li class="divider"></li>
                                        <?php echo e(Form::open(['route' => ['notify.delete', $notify->id], 'method' => 'GET'] )); ?>
...
<div id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        <?php echo Form::open(['route' => 'notify.store', 'method' => 'post', 'files' => true]); ?>

        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('Add Notify Party')); ?></h5>
          ...
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
            <div class="row">
                ...
                <div class="col-md-4 form-group">
                    ...
                    <?php echo e(Form::text('state',null,array('required' => 'required','class' => 'form-control', 'placeholder' => 'Type state name...'))); ?>

                </div>
                <div class="col-md-4 form-group">
                    <label><?php echo e(trans('ZIP Code')); ?> *</label>
                    <?php echo e(Form::text('zip_code',null,array('required' => 'required','class' => 'form-control', 'placeholder' => 'Type zip code...'))); ?>
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        <?php echo e(Form::open(['route' => ['notify.update', 1], 'method' => 'PUT', 'files' => true] )); ?>

        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('Edit Notify Party')); ?></h5>
          <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
        </div>
        <div class="modal-body">
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
...
<script type="text/javascript">
    ...
    $(document).on("click", ".open-EditCategoryDialog", function(){
          ...
          $.get(url, function(data){
            ...
            $("#editModal input[name='zip_code']").val(data['zip_code']);
            ...
            $("#editModal input[name='notify_id']").val(data['id']);
          });
    });
    ...
    $('#user-table').DataTable( {
        ...
        buttons: [
            {
                extend: 'pdf',
                title: 'Consignee & Notify Party List',
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\wingking-fasion\resources\views/notify_party/index.blade.php ENDPATH**/ ?>