            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['route' => ['proforma_invoice.update',$lim_invoice_data->id], 'method' => 'put', 'files' => true, 'id' => 'purchase-form']); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="invoice_no" class="form-control" placeholder="Enter Invoice No" value="<?php echo e($lim_invoice_data->invoice_no); ?>" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter Date"
                                             name="date" class="datepicker form-control" value="<?php echo e(date("d-M-Y", strtotime($lim_invoice_data->date))); ?>" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="invoice_to_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select invoice to...">
                                                <?php $__currentLoopData = $lims_invoice_to_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($invoice->id); ?>" <?php echo e(($invoice->id == $lim_invoice_data->invoice_to_id)?'selected':''); ?>><?php echo e($invoice->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            <?php if($errors->has('invoice_to_id')): ?>
                                                <span class="text-danger">
                                                    <?php echo e($errors->first('invoice_to_id')); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php if(!empty($lim_invoice_data->revised_date)): ?>
                                                <input type="text" name="revised_date" value="<?php echo e(date("d-M-Y", strtotime($lim_invoice_data->revised_date))); ?>" class="datepicker form-control">
                                            <?php else: ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="account_of" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select account of..." required>
                                                <option value="1" <?php echo e(($lim_invoice_data->account_of == 1) ? 'selected' : ''); ?>>Winking</option>
                                                <option value="2" <?php echo e(($lim_invoice_data->account_of == 2) ? 'selected' : ''); ?>>Artisan</option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="customer_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select customer ...">
                                                <?php $__currentLoopData = $lims_customer_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($customer->id); ?>" <?php echo e(($lim_invoice_data->customer_id == $customer->id)?'selected':''); ?>><?php echo e($customer->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            value="<?php echo e($lim_invoice_data->season); ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="delivery_date" placeholder="Enter Delivery Date"class="datepicker form-control" value=<?php echo e(date("d-M-Y", strtotime($lim_invoice_data->delivery_date))); ?> required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select status...">
                                                <option value="Running" <?php echo e(($lim_invoice_data->status == 'Running')?'selected':''); ?> >Running</option>
                                                <option value="Delivered" <?php echo e(($lim_invoice_data->status == 'Delivered')?'selected':''); ?> >Delivered</option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                            placeholder="Enter Total Quantity" name="total_qty" id="total_qty" class="form-control total_qty" required value=<?php echo e($lim_invoice_data->total_qty); ?>>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter Total Amount"
                                             class="form-control total_amount" required value=<?php echo e($lim_invoice_data->total_amount); ?>>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <p style="color: red;"><?php echo e($lim_invoice_data->document); ?></p>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\wingking-fasion\resources\views/proforma_invoice/edit.blade.php ENDPATH**/ ?>