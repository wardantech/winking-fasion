            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['route' => ['cost_sheet.update',$lims_cost_data->id], 'method' => 'put', 'files' => true]); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="style_no" class="form-control" value="<?php echo e($lims_cost_data->style_no); ?>" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select required name="customer_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select customer...">
                                                <?php $__currentLoopData = $lims_customer_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                     <option value="<?php echo e($customer->id); ?>" <?php echo($customer->id == $lims_cost_data->customer_id) ? 'selected' : ''; ?>><?php echo e($customer->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Season *</label>
                                            <input type="text" name="season" class="form-control" value="<?php echo e($lims_cost_data->season); ?>" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="brand" class="form-control" value="<?php echo e($lims_cost_data->brand); ?>" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="size_scale" class="form-control" value="<?php echo e($lims_cost_data->size_scale); ?>" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="item_description" class="form-control" value="<?php echo e($lims_cost_data->item_description); ?>" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="order_quantity" class="form-control" value="<?php echo e($lims_cost_data->order_quantity); ?>" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="target_price" class="form-control" value="<?php echo e($lims_cost_data->target_price); ?>" required>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table id="dynamicSection" width="100%">
                                            ...
                                            <tbody>
                                            <?php $__currentLoopData = $lims_fabrics_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $fabric): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><input type="text" name="fabric[]" class="form-control" value="<?php echo e($fabric->fabric); ?>" required></td>
                                                    <td><input type="text" name="fabric_item_code[]" class="form-control" value="<?php echo e($fabric->fabric_item_code); ?>"></td>
                                                    <td width="25%"><input type="text" name="fabric_item_description[]" class="form-control" value="<?php echo e($fabric->fabric_item_description); ?>"></td>
                                                    <td width="10%"><input type="number" name="fabric_price[]" id="fabric_price" min="0" step="0.01" class="form-control fabric_price" value="<?php echo e($fabric->fabric_price); ?>" required></td>
                                                    <td width="10%"><input type="number" name="fabric_consumption[]" id="fabric_consumption" min="0" step="0.01" class="form-control fabric_consumption" value="<?php echo e($fabric->fabric_consumption); ?>" required></td>
                                                    <td>
                                                        <select name="fabric_consump_unit[]" id="" class="form-control">
                                                            <option value="yds" <?php echo e(($fabric->fabric_consump_unit == 'yds'?'selected':'')); ?>>yds</option>
                                                            <option value="kgs" <?php echo e(($fabric->fabric_consump_unit == 'kgs'?'selected':'')); ?>>kgs</option>
                                                            <option value="mtrs" <?php echo e(($fabric->fabric_consump_unit == 'mtrs'?'selected':'')); ?>>mtrs</option>
                                                        </select>
                                                    </td>
                                                    <td width="10%"><input type="number" name="fabric_wastage[]" id="fabric_wastage" min="0" step="1" class="form-control fabric_wastage" value="<?php echo e($fabric->fabric_wastage); ?>" required></td>
                                                    <td width="10%"><input type="number" name="fabric_total_price[]" id="fabric_total_price" min="0" class="form-control fabric_total_price" readonly required value="<?php echo e($fabric->fabric_total_price); ?>"></td>
                                                    <td>
                                                        <?php if($key == 0): ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="fabric_total_cost" id="fabric_total_cost" class="form-control fabric_total_cost" value="<?php echo e($lims_cost_data->fabric_total_cost); ?>" readonly required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Total Trims ($)</label>
                                            <input type="text" name="trim_total_cost" id="trim_total_cost" class="form-control trim_total_cost" value="<?php echo e($lims_cost_data->trim_total_cost); ?>" readonly required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table id="dynamicTrim" width="100%">
                                            ...
                                            <tbody>
                                            <?php $__currentLoopData = $lims_details_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><input type="text" name="trimming[]" class="form-control" value="<?php echo e($detail->trimming); ?>" required></td>
                                                    <td width="15%"><input type="text" name="trim_item_code[]" class="form-control" value="<?php echo e($detail->trim_item_code); ?>"></td>
                                                    <td><input type="text" name="trim_item_description[]" class="form-control" value="<?php echo e($detail->trim_item_description); ?>"></td>
                                                    <td width="10%"><input type="number" name="trim_price[]" id="trim_price" min="0" step="0.01" value="<?php echo e($detail->trim_price); ?>" class="form-control trim_price" required></td>
                                                    <td width="10%"><input type="number" name="trim_consumption[]" id="trim_consumption" min="0" value="<?php echo e($detail->trim_consumption); ?>" step="0.01" class="form-control trim_consumption" required></td>
                                                    <td>
                                                        <select name="trim_consump_unit[]" id="" class="form-control">
                                                            <option value="dzn" <?php echo e(($detail->trim_consump_unit == 'dzn'?'selected':'')); ?>>dzn</option>
                                                            <option value="yds" <?php echo e(($detail->trim_consump_unit == 'yds'?'selected':'')); ?>>yds</option>
                                                            <option value="cone" <?php echo e(($detail->trim_consump_unit == 'cone'?'selected':'')); ?>>cone</option>
                                                            <option value="pcs" <?php echo e(($detail->trim_consump_unit == 'pcs'?'selected':'')); ?>>pcs</option>
                                                        </select>
                                                    </td>
                                                    <td width="10%"><input type="number" name="trim_wastage[]" id="trim_wastage" min="0" step="1" value="<?php echo e($detail->trim_wastage); ?>" class="form-control trim_wastage" required></td>
                                                    <td width="10%"><input type="number" name="trim_total_price[]" id="trim_total_price" min="0" value="<?php echo e($detail->trim_total_price); ?>" class="form-control trim_total_price" readonly></td>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <table id="dynamicTrim" width="100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><input type="number" name="making_price" id="making_price" min="0" value="<?php echo e($lims_cost_data->making_price); ?>" step="0.01" class="form-control making_price" required></td>
                                                <td><input type="number" name="washing_price" id="washing_price" min="0" value="<?php echo e($lims_cost_data->washing_price); ?>" step="0.01" class="form-control washing_price" required></td>
                                                <td><input type="number" name="dry_process_price" id="dry_process_price" value="<?php echo e($lims_cost_data->dry_process_price); ?>"  min="0" step="1" class="form-control dry_process_price" required></td>
                                                <td><input type="number" name="other_price" id="other_price" value="<?php echo e($lims_cost_data->other_price); ?>" class="form-control other_price" required></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <table id="dynamicTrim" width="100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><input type="text" name="washing_description" id="washing_description" value="<?php echo e($lims_cost_data->washing_description); ?>" class="form-control"></td>
                                                <td><input type="text" name="dry_process_description" id="dry_process_description" value="<?php echo e($lims_cost_data->dry_process_description); ?>" class="form-control"></td>
                            ...
                            <div class="row" style="margin-top:50px;">
                                    ...
                                    <table id="dynamicTrim" width="100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="number" name="cmptw_total_price" id="cmptw_total_price" value="<?php echo e($lims_cost_data->cmptw_total_price); ?>" class="form-control cmptw_total_price" readonly required></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><input type="number" name="fob_total_price" id="fob_total_price" value="<?php echo e($lims_cost_data->fob_total_price); ?>" class="form-control fob_total_price" readonly required></td>
                                            </tr>
                                            <tr>
                                                <td width="30%"><b>TF*</b></td>
                                                <td><input type="number" name="tf_wastage" id="tf_wastage" min="0" step="1" value="<?php echo e($lims_cost_data->tf_wastage); ?>" class="form-control tf_wastage" required></td>
                                                <td><input type="number" name="tf_cost" id="tf_total_price" value="<?php echo e($lims_cost_data->tf_cost); ?>" class="form-control tf_total_price" readonly required></td>
                                            </tr>
                                            <tr>
                                                <td width="30%"><b>CTL*</b></td>
                                                <td><input type="number" name="cil_wastage" id="cil_wastage" min="0" step="0.1" value="<?php echo e($lims_cost_data->cil_wastage); ?>" class="form-control cil_wastage" required></td>
                                                <td><input type="number" name="cil_price" id="cil_total_price" value="<?php echo e(number_format((float)$lims_cost_data->cil_price, 2, '.', '')); ?>" class="form-control cil_total_price" readonly required></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><input type="number" name="total_cost" id="total_cost_price" value="<?php echo e($lims_cost_data->total_cost); ?>" class="form-control total_cost_price" readonly required></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td ><input type="number" name="cost_per_pc" id="cost_per_pc" value="<?php echo e($lims_cost_data->cost_per_pc); ?>" class="form-control cost_per_pc" readonly required></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="offered_fob" value="<?php echo e(number_format((float)$lims_cost_data->offered_fob, 2, '.', '')); ?>" class="form-control" required>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\wingking-fasion\resources\views/cost_sheet/edit.blade.php ENDPATH**/ ?>