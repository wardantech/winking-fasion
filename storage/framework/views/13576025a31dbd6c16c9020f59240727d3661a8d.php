                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <button type="button" data-id="<?php echo e($expense_category->id); ?>" class="editModal btn btn-link"><i class="dripicons-document-edit"></i> Edit</button>
                                </li>
                                <li class="divider"></li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
            <div class="form-group">
                <label><?php echo e(trans('file.Code')); ?> *</label>
                <?php echo e(Form::text('code',null,array('required' => 'required', 'class' => 'form-control', 'id' => 'edit_code','placeholder' => 'Type expense category code...'))); ?>

            </div>
            <div class="form-group">
                <label><?php echo e(trans('file.name')); ?> *</label>
                <?php echo e(Form::text('name',null,array('required' => 'required', 'class' => 'form-control', 'id' => 'edit_name','placeholder' => 'Type expense category name...'))); ?>

            </div>
        <input type="hidden" name="expense_category_id" id="edit_category_id">
        <div class="form-group">
            <input type="submit" value="<?php echo e(trans('file.submit')); ?>" class="btn btn-primary">
          </div>
        </div>
...
<script type="text/javascript">
    ...
    $(".editModal").on("click",function(){
        ...
        $.get('expense_categories/' + id +'/edit', function (data) {
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\salepro\winking-fasion\resources\views/expense_category/index.blade.php ENDPATH**/ ?>