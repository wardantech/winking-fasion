        ...
        <table id="department-table" class="table">
            <thead>
                <tr>
                    ...
                    <th style="text-align:center;"><?php echo e(trans('Number of Employee')); ?></th>
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($department->id); ?>">
                    ...
                    <td style="text-align:center;"><?php echo e($department->employees->count()); ?></td>
                    <td>
                        <div class="btn-group">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\wingking-fasion\resources\views/department/index.blade.php ENDPATH**/ ?>