                                ...
                                <div class="row">
                                    <div class="col-md-12" style="margin:30px 0px;">
                                        ...
                                        <table id="sizeSection" width="100%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><input type="text" name="size1[]" class="form-control" value="<?php echo e($value->size1); ?>" placeholder="Enter Size"></td>
                                                    <td><input type="text" name="prepack1[]" class="form-control" value="<?php echo e($value->prepack1); ?>" placeholder="Enter prepack"></td>
                                                    <td><input type="number" min="0" step="any" name="quantity1[]" value="<?php echo e($value->quantity1); ?>" id="quantity<?php echo e($key+1); ?>" class="form-control quantity<?php echo e($key+1); ?>" placeholder="Enter quantity"></td>
                                                </tr>
                                                <tr>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\wingking-fasion\resources\views/purchase/order_edit.blade.php ENDPATH**/ ?>