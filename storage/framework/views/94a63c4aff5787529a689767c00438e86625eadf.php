...
<section>
    ...
    <div class="container-fluid">
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> <?php echo e(trans("Add Ship To")); ?></button>&nbsp;
    </div>
    ...
    <div class="table-responsive">
        <table id="user-table" class="table">
            ...
            <tbody>
                <?php $__currentLoopData = $lims_ship_to; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ship): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr data-id="<?php echo e($ship->id); ?>">
                        <td><?php echo e($key); ?></td>
                        <td><?php echo e($ship->name); ?></td>
                        <td><?php echo e($ship->email); ?></td>
                        <td><?php echo e($ship->phone); ?></td>
                        <td><?php echo e($ship->address); ?>, <?php echo e($ship->city); ?>, <?php echo e($ship->state); ?>, <?php echo e($ship->zip); ?>, <?php echo e($ship->country); ?></td>
                        <?php if($ship->is_active == 1): ?>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    ...
                                    <li><button type="button" data-id="<?php echo e($ship->id); ?>" class="open-EditCategoryDialog btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></button></li>

                                    <li class="divider"></li>
                                    <?php echo e(Form::open(['route' => ['shipTo.delete', $ship->id], 'method' => 'GET'] )); ?>
...
<div id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        <?php echo Form::open(['route' => 'ship_to.store', 'method' => 'post', 'files' => true]); ?>

        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('Add Ship To')); ?></h5>
          ...
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <?php echo e(Form::text('zip',null,array('required' => 'required','class' => 'form-control', 'placeholder' => 'Type zip code...'))); ?>
                ...
                <div class="col-md-6 form-group">
                    ...
                    <?php echo e(Form::email('email',null,array('class' => 'form-control', 'placeholder' => 'Type email address...'))); ?>
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        <?php echo e(Form::open(['route' => ['ship.update', 1], 'method' => 'PUT', 'files' => true] )); ?>
        ...
        <div class="modal-body">
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
            <div class="row">
                <div class="col-md-6 form-group">
                    <input type="hidden" name="ship_to_id">
                    <label><?php echo e(trans('file.name')); ?> *</label>
                    <?php echo e(Form::text('name',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'Type vendor or shipper name...'))); ?>
...
<script type="text/javascript">
    ...
    $("ul#people #ship-list-menu").addClass("active");
    ...
    $(document).on("click", ".open-EditCategoryDialog", function(){
          ...
          $.get(url, function(data){
            ...
            $("#editModal input[name='zip']").val(data['zip']);
            $("#editModal input[name='email']").val(data['email']);
            $("#editModal input[name='ship_to_id']").val(data['id']);
          });
    });
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\wingking-fasion\resources\views/ship/index.blade.php ENDPATH**/ ?>