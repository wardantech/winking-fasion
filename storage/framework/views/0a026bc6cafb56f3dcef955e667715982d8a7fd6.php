...
<section>
    <div class="container-fluid">
        <button class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> <?php echo e(trans('Add Deposit')); ?> </button>
    </div>
        ...
        <table id="payroll-table" class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('Deposit Purpose')); ?></th>
                    <th><?php echo e(trans('file.date')); ?></th>
                    
                    <th><?php echo e(trans('Account')); ?></th>
                    <th><?php echo e(trans('Deposit By')); ?></th>
            ...
            <tbody>
                <?php $__currentLoopData = $lims_deposit_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr data-id="<?php echo e($deposit->id); ?>">
                        <td><?php echo e($key); ?></td>
                        <td><?php echo e($deposit->title); ?></td>
                        <td><?php echo e(date('d-M-Y',strtotime($deposit->date))); ?></td>
                        <td><?php echo e($deposit->account->name); ?> - [<?php echo e($deposit->account->account_no); ?>]</td>
                        <td><?php echo e($deposit->paid_by); ?></td>
                        <td><?php echo e(number_format((float)$deposit->amount, 2, '.', '')); ?></td>
                        <?php if($deposit->paying_method == 1): ?>
                            <td>Cash</td>
                        <?php elseif($deposit->paying_method == 2): ?>
                        <?php if($deposit->reference): ?>
                                <td>Cheque - [<?php echo e($deposit->reference); ?>]</td>
                        <?php endif; ?>
                        <?php else: ?>
                            <?php if($deposit->reference): ?>
                                <td>Transfer - [<?php echo e($deposit->reference); ?>]</td>
                            <?php endif; ?>
                        <?php endif; ?>
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    <li>
                                        <button type="button" data-id="<?php echo e($deposit->id); ?>" data-reference="<?php echo e($deposit->reference); ?>" data-account_id="<?php echo e($deposit->account_id); ?>"  data-title="<?php echo e($deposit->title); ?>" data-date="<?php echo e($deposit->date); ?>" data-amount="<?php echo e($deposit->amount); ?>" data-paid="<?php echo e($deposit->paid_by); ?>"
                                            data-note="<?php echo e($deposit->note); ?>" data-paying_method="<?php echo e($deposit->paying_method); ?>" class="edit-btn btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></button>
                                    </li>
                                    <li class="divider"></li>
                                    <?php echo e(Form::open(['route' => ['deposits.destroy', $deposit->id], 'method' => 'DELETE'] )); ?>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('Add Depoosit')); ?></h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
              <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                <?php echo Form::open(['route' => 'deposits.store', 'method' => 'post', 'files' => true]); ?>

                <div class="row">
                    <div class="col-md-6 form-group">
                        <label><?php echo e(trans('Deposit Purpose')); ?> *</label>
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('Update Deposit')); ?></h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
              <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                <?php echo Form::open(['route' => ['deposits.update', 1], 'method' => 'put', 'files' => true]); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\wingking-fasion\resources\views/deposit/index.blade.php ENDPATH**/ ?>