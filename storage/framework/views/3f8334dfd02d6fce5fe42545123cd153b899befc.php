...
<section>
    <div class="container-fluid">
        <button class="btn btn-info" data-toggle="modal" data-target="#create-money-transfer-modal"><i class="dripicons-plus"></i> <?php echo e(trans('Add Fund Transfer')); ?></button>
    </div>
        ...
        <table id="money-transfer-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($money_transfer->id); ?>">
                    ...
                    <td><?php echo e(date('d-M-Y', strtotime($money_transfer->created_at->toDateString()))); ?></td>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('Add Fund Transfer')); ?></h5>
...
<div id="edit-money-transfer-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('Update Fund Transfer')); ?></h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
                <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#edit-btn').on('click', function() {
            ...
            $("#edit-money-transfer-modal input[name='date']").val(moment(updateDate).format('D - MMM - YYYY'));
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\wingking-fasion\resources\views/money_transfer/index.blade.php ENDPATH**/ ?>