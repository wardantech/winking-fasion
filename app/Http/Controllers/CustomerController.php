...
class CustomerController extends Controller
{
    public function index()
    {
        ...
        if($role->hasPermissionTo('customers-index')){
            ...
            return view('customer.index', compact('lims_customer_all', 'all_permission','interests_list'));
        }
        else
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('customers-add')){
            ...
            return view('customer.create', compact('lims_customer_group_all','interests'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function edit($id)
    {
        ...
        if($role->hasPermissionTo('customers-edit')){
            ...
            $lims_customer_group_all = CustomerGroup::where('is_active',true)->get();
            $interests = Interest::where('is_active',true)->get();
            return view('customer.edit', compact('lims_customer_data','lims_customer_group_all','interests'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function filterCustomer(Request $request){
        ...
        if($interest_id == 0 && ($start_date == null && $start_date == null)){
             return redirect()->back()->with('not_permitted','Please select date range or interest for filtering');
        }
        ...
        if($role->hasPermissionTo('customers-index')){
            ...
            $lims_customer_all = Customer::where(function($query) use ($interest_id,$start_date,$end_date,$start,$end){
                    if($interest_id != 0 && $start_date != null && $end_date != null){
            ...
            $interests_list = Interest::where('is_active',true)->get();
            return view('customer.index', compact('lims_customer_all', 'all_permission','interests_list','interest_id','start_date','end_date'));
